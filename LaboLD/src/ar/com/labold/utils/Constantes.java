...
public class Constantes {
	...
	//MEDICO
	public static final String EXITO_ALTA_MEDICO = "El M閐ico se ha dado de alta con exito";
	
	public static final String EXISTE_MEDICO = "Ya existe un M閐ico con esa matricula";
	
	public static final String EXITO_MODIFICACION_MEDICO = "El M閐ico se ha modificado con exito";
	//FIN MEDICO	
	...
	public static final String EXITO_ALTA_ESTUDIO2 = " unidades de facturaci髇";
